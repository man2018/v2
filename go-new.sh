...
downloadV2Ray(){
    ...
    if [[ "${DIST_SRC}" == "jsdelivr" ]]; then
        DOWNLOAD_LINK="https://cdn.jsdelivr.net/gh/man2018/dist/v2ray-linux-${VDIS}.zip"
    else
        DOWNLOAD_LINK="https://github.com/man2018/v2/releases/download/${NEW_VER}/v2ray-linux-${VDIS}.zip"
    fi
...
getVersion(){
    if [[ -n "$VERSION" ]]; then
        ...
        TAG_URL="https://api.github.com/repos/man2018/v2/releases/latest"
